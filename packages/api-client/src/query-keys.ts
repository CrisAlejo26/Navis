...
export const queryKeys = {
    ...
    calendar: {
        ...
        patterns: (calendarId: string) =>
            [...queryKeys.calendar.all, 'patterns', calendarId] as const,
    ...
    believers: {
        ...
        notes: (id: string, query: object) =>
            [...queryKeys.believers.all, 'notes', id, query] as const,
