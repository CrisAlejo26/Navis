...
Las cuatro apps comparten número de versión. «Navis 1.2.0» es una cosa
...
| Secreto                     | Valor                       |
| --------------------------- | --------------------------- |
| `ANDROID_KEYSTORE_BASE64`   | `base64 -w0 navis.keystore` |
| `ANDROID_KEYSTORE_PASSWORD` | La contraseña del almacén   |
| `ANDROID_KEY_ALIAS`         | `navis`                     |
