...
> **Instantánea del 2026-08-04; ya no se mantiene.** Recoge cómo estaba la infraestructura
> cuando aún no había funcionalidad de negocio. El estado actual de cada funcionalidad
> está en el índice de [`docs/README.md`](../README.md).
...
El **calendario ([RFC 0002](../rfcs/0002-calendario-de-programaciones-implementado.md))**, los
**creyentes con su bitácora ([RFC 0003](../rfcs/0003-creyentes-y-notas-implementado.md))**, las
**profecías personales ([RFC 0004](../rfcs/0004-profecias-personales-implementado.md))** y los
**sueños personales ([RFC 0005](../rfcs/0005-suenos-personales-implementado.md))** ya están
implementados en API y web, y con ellos **exportar lo que se ve
([RFC 0009](../rfcs/0009-exportar-listados-implementado.md))**. Con todo eso hay por fin datos
...
1. **[RFC 0001](../rfcs/0001-panel-de-metricas-implementado.md) — panel de métricas**, que ya
   tiene datos que contar: quién pide atención, cuántas notas hay este mes y
   cómo va el reparto del calendario.
2. **[RFC 0010](../rfcs/0010-listas-compartidas-implementado.md) — listas**, la primera
...
3. **[RFC 0006](../rfcs/0006-comunicaciones-implementado.md) — comunicaciones**, la primera
