...
export function PhotoField({
  ...
  return (
    <View className="gap-3 flex-row items-center">
      ...
      >
        {uri ? (
          <Image source={{ uri }} style={{ width: BOX, height: BOX }} resizeMode="cover" />
        ) : (
      ...
      <View className="gap-0.5 flex-1">
        <Text className="text-sm font-sans-medium text-foreground">{t('believers.photo')}</Text>
        ...
        <View className="gap-4 mt-0.5 flex-row items-center">
          ...
          >
            <Text className="text-sm font-sans-medium" style={{ color: palette.primary }}>
              {label}
            </Text>
          </Pressable>
          {uri ? (
            <Pressable
              ...
              className="active:opacity-70"
            >
              <Text className="text-sm font-sans-medium" style={{ color: palette.destructive }}>
