    ...
    <BottomSheet visible onClose={onClose} title={note ? t('notes.edit') : t('notes.add')}>
      ...
      >
        <View className="gap-2">
          <Text className="text-sm font-sans-medium text-foreground">{t('notes.kind')}</Text>
            ...
            <View className="gap-2 flex-row items-end">
              <View className="w-24">
                <TextField
                  ...
                  onChangeText={(text) =>
                    setValues({ ...values, remindTime: text.replaceAll(/[^0-9:]/g, '') })
                  }
                  placeholder="19:00"
                />
              </View>
              <View className="flex-1">
                <TextField
                  ...
                  onChangeText={(text) => setValues({ ...values, remindText: text })}
      ...
      <View className="gap-2 pt-2" style={{ borderTopWidth: 1, borderTopColor: palette.border }}>
