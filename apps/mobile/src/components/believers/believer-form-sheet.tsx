        ...
        >
            ...
            >
                ...
                <View className="gap-3 p-3 rounded-xl bg-muted">
                    <ChipGroup
                        ...
                        onToggle={(id) =>
                            setValues({ ...values, ministries: toggle(values.ministries, id) })
                        }
                    />
                    <ChipGroup
                        ...
                        onToggle={(id) =>
                            setValues({ ...values, giftIds: toggle(values.giftIds, id) })
                        }
                    />
                    <ChipGroup
                        ...
                        onToggle={(id) =>
                            setValues({ ...values, tagIds: toggle(values.tagIds, id) })
                        }
                    />
                </View>
            ...
            <View
                ...
                style={{
                    borderTopWidth: 1,
                    borderTopColor:
                        themeColorsHex[useThemeStore((state) => state.resolvedTheme)].border,
                }}
            >
                <Button
                ...
                {options.map((option) => {
                    ...
                    return (
                        <Chip
                            ...
                            color={
                                option.accent.startsWith('#')
                                    ? option.accent
                                    : (palette[key] ?? palette.primary)
                            }
