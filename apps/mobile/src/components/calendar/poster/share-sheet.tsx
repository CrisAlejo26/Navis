...
const ASPECTS: { value: PosterAspect; labelKey: string; hintKey: string }[] = [
    {
        value: 'portrait',
        labelKey: 'calendar.sharePortrait',
        hintKey: 'calendar.sharePortraitHint',
    },
        ...
        const days =
            sedesFiltro.length === 0
                ...
                : schedule.days.map((day) => ({
                      ...day,
                      meetings: day.meetings.filter((one) =>
                          sedesFiltro.includes(one.congregationId),
                      ),
                  }));
