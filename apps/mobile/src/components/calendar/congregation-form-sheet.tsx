  ...
  return (
    ...
    >
      <View className="gap-3">
        <TextField label={t('calendar.congregationName')} value={name} onChangeText={setName} />
        <TextField label={t('calendar.congregationCity')} value={city} onChangeText={setCity} />
        ...
        <View className="gap-1.5">
          ...
          <View className="gap-2 flex-row flex-wrap">
            {ACCENT_PALETTE.map((hex) => (
              ...
              >
                <View className="h-6 w-6 rounded-full" style={{ backgroundColor: hex }} />
              </Pressable>
            ))}
          </View>
        </View>
