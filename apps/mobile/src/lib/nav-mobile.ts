...
export const MORE_MENU_ENTRIES = [
    {
        ...
        group: 'general',
        rfc: '0004-profecias-personales-implementado.md',
    },
    {
        name: 'dreams',
        labelKey: 'nav.dreams',
        icon: 'moon-outline',
        group: 'general',
        rfc: '0005-suenos-personales-implementado.md',
    },
    {
        name: 'teachings',
    ...
    },
    {
        ...
        icon: 'list-outline',
        group: 'church',
        rfc: '0010-listas-compartidas-implementado.md',
    },
    {
        name: 'tables',
        labelKey: 'nav.tables',
        icon: 'grid-outline',
        group: 'church',
        rfc: '0021-tablas-personalizadas-implementado.md',
    },
    {
        name: 'journal',
        ...
        group: 'church',
        rfc: '0017-notas-de-iglesia-implementado.md',
    },
    {
        name: 'tasks',
        labelKey: 'nav.tasks',
