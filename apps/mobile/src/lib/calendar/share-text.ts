...
/**
 * El tramo en texto plano, listo para pegar en un grupo de WhatsApp —el mismo
 * formato de `apps/web/src/lib/calendar/share-text.ts`—.
 *
 * Es el respaldo de la lámina (§9.3) y lo mínimo que siempre funciona. Las
 * fases sin nadie **también salen**, igual que en pantalla: si falta alguien,
 * que se vea.
 */
