  ...
  return (
    <View className="flex-1 bg-background">
      <AppBar
        ...
        actions={[{ icon: 'add', label: t('prophecies.add'), onPress: () => setFormOpen(true) }]}
      />
      <View className="gap-3 px-4 pb-2">
        <SearchField value={search} onChangeText={setSearch} placeholder={t('prophecies.search')} />
      ...
      {isPending ? (
        ...
        <EmptyState
          ...
          title={search || query.state ? t('prophecies.noResults') : t('prophecies.emptyTitle')}
