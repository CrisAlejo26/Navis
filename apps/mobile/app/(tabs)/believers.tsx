import type { BelieversQuery } from '@navis/shared';
 ...
 * vistazo. Paginación en el repositorio, filtros en el estado local —en la
 * web viven en la URL; aquí en la ruta no hay URL— y la única acción en lote
 * que existe a propósito: poner sede.
 */
