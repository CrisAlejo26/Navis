...
export default function ComponentsScreen() {
    ...
    return (
        // Regla 5 §5: los campos de demo se enfocan a mitad de pantalla y en iOS
        // el teclado los taparía; Android redimensiona solo (adjustResize).
        ...
        >
            <ScrollView
                className="flex-1 bg-background"
                contentContainerClassName="gap-8 p-4 pt-16"
            >
                        ...
                        options={[
                            {
                                value: 'general',
                                label: 'General',
                                description: 'Lo personal de cada cual',
                            },
                            {
                                value: 'church',
                                label: 'La iglesia',
                                description: 'Lo de la iglesia activa',
                            },
                        ]}
                    />
                </Section>
                        ...
                        {chipTags.map((chip) => (
                            <Chip
                                ...
                                onPress={() =>
                                    setChipTags((tags) =>
                                        tags.map((c) =>
                                            c.id === chip.id ? { ...c, selected: !c.selected } : c,
                                        ),
                                    )
                                }
                            />
