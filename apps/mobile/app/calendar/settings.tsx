...
export default function CalendarSettingsScreen() {
  ...
  return (
    <View className="flex-1 bg-background">
          ...
          <View className="gap-2">
            <View className="gap-1 flex-row flex-wrap">
              {congregations.map((one) => (
                <Chip key={one.id} label={one.name} selected onPress={() => setSede(one)} />
              ))}
            </View>
            <Button
              variant="secondary"
      ...
      {sede ? <CongregationFormSheet congregation={sede} onClose={() => setSede(null)} /> : null}
      ...
      >
        <View className="gap-3">
          <TextField label={t('calendar.calendarName')} value={nombre} onChangeText={setNombre} />
          <Button
            title={t('common.save')}
      ...
      >
        <View className="gap-3">
          <TextField label={t('calendar.calendarName')} value={nuevo} onChangeText={setNuevo} />
