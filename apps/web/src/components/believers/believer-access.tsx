                    ...
                    <ul className="gap-1 flex flex-col">
                        {suyas.map((one) => (
                            ...
                            >
                                <span
                                    aria-hidden
                                    className="size-2 shrink-0 rounded-full bg-[var(--acento)]"
                                />
                                <Link
                                    to={`/lists/${one.slug}`}
                                ...
                                {one.visibility !== 'private' && (
                                    <VisibilityBadge visibility={one.visibility} />
                                )}
                                ...
                                {can('lists.manage') && (
                                    <button
                                        ...
                                        onClick={() => {
                                            remove.mutate(
                                                { listId: one.id, believerId: believer.id },
                                                {
                                                    onSuccess: () => {
                                                        toast.success(
                                                            t('lists.memberRemoved', {
                                                                name: one.name,
                                                            }),
                                                        );
                                                    },
