 ...
 * ninguna pieza nueva de carga por carril. Los filtros de la vista (D24, D5)
 * viajan junto al suyo propio, que es el valor del carril.
 */
export function KanbanLane({
    ...
    /** Los filtros de la vista activa, ya validados contra sus columnas. */
    extraFilters: readonly RowFilter[];
    editable: boolean;
    ...
    return (
        ...
        >
            <div className="px-3 py-2.5 gap-2 flex shrink-0 items-center border-b border-[var(--acento)]/20">
                <span
                    aria-hidden
                    className="h-2.5 w-2.5 shrink-0 rounded-full bg-[var(--acento)]"
                />
